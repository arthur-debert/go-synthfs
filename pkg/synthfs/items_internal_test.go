...
func TestFileItem(t *testing.T) {
	...
	// Test default mode
	defaultModeFile := NewFile("default.txt")
...
func TestDirectoryItem(t *testing.T) {
	...
	// Test default mode
	defaultModeDir := NewDirectory("defaultdir")
...
func TestSymlinkItem(t *testing.T) {
	...
	link := NewSymlink(linkPath, targetPath)
...
func TestArchiveItem(t *testing.T) {
	...
	archive := NewArchive(archivePath, format, sources)
	...
	if archive.Format() != targets.ArchiveFormat(format) {
